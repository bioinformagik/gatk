...
import org.broadinstitute.hellbender.cmdline.argumentcollections.ExampleSlidingWindowArgumentCollection;
...
import org.broadinstitute.hellbender.engine.SlidingWindowWalker;
...
public final class ExampleSlidingWindowWalker extends SlidingWindowWalker {
    ...
    public SlidingWindowArgumentCollection getSlidingWindowArguments() {
        ...
        return new ExampleSlidingWindowArgumentCollection(100, 50, 0);
    }
